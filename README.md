# Описание задачи
Скрипт извлекает характеристики товаров (цена, бренд, категория) из текстовых описаний в формате .csv с помощью LLM (Groq API, модель llama-3.3-70b-versatile).
